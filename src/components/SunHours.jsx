  ...
  <div className="d-flex justify-content-between condition-tab">
    <div className="d-flex internal-icon">
      <div className="sunrise weather-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-sunrise" viewBox="0 0 16 16">
      ...
      <div className="sunset weather-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-sunset" viewBox="0 0 16 16">
      ...
      <div>
        <h5>Sunrise</h5>
        <p className="condition-detail">{(infoToPass === undefined) ? null : null} &#37;</p>
      </div>
    </div>
